# this prompt hook replaces the exit status number with its signal name. we
# can't know for sure if these return codes are actually caused by the signals,
# but usually they are, since few programs output exit codes > 128 for error
# conditions.
